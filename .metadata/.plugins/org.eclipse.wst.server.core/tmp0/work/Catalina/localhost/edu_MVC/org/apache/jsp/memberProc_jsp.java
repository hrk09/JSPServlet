 ...
 * Generated at: 2022-07-01 05:47:16 UTC
...
public final class memberProc_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.edu.biz.MemberService");
  }
...
return;
    ...
    try {
      ...
      out.write("<!-- 소스를 완성하세요 -->\r\n");
      out.write("\r\n");
      com.edu.beans.Member member = null;
      member = (com.edu.beans.Member) _jspx_page_context.getAttribute("member", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (member == null){
        member = new com.edu.beans.Member();
	...
	biz.memberInsert(member);
      ...
      out.write("\r\n");
      if (true) {
        _jspx_page_context.forward("memberOutput.jsp");
        return;
      }
      out.write('\r');
      out.write('\n');
